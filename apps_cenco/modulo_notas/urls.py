...
urlpatterns = [
    ...
    url(r'^consultar_evaluaciones/$', views.consultar_evaluaciones),
    url(r'^finalizar_materia/(?P<id_alumno>\d+)$', views.finalizar_materia),
    url(r'^record_notas/$', views.ver_record_notas),
    url(r'^ingresar_evaluaciones/$', views.ingresar_evaluaciones),
