# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-11-22 15:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ponderacion_evaluacion', models.DecimalField(decimal_places=4, max_digits=5)),
                ...
                ('profesor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='db_app.Empleado')),
            ],
        ),
        migrations.CreateModel(
            name='Expediente',
