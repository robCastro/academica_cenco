# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-06-08 19:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cursa', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='db_app.Cursa')),
            ],
        ),
        migrations.CreateModel(
            name='Examen',
        ...
        migrations.CreateModel(
            name='Reservacion',
            fields=[
                ('codigo_reservacion', models.AutoField(primary_key=True, serialize=False)),
                ('fecha_reservacion', models.DateField()),
                ('alumno', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='db_app.Alumno')),
                ('horario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='db_app.Horario')),
            ],
        ),
        migrations.CreateModel(
            name='Telefono',
        ...
        migrations.AddField(
            ...
            name='examen',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='db_app.Examen'),
        ),
        migrations.AddField(
            model_name='evaluacion',
            name='profesor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='db_app.Empleado'),
        ),
        migrations.AddField(
